            ...
            <div className="px-[20px] pt-[4px] pb-[24px]">
              <div className="flex flex-[0_0_calc(50%_-_20px)] mb-[24px]">
                <InputText
                  placeholder=""
                  label={
                    ('job_title_label' in item && item.job_title_label) ||
                    ('school_label' in item && item.school_label) ||
                    ''
                  }
                  reference={
                    ('job_title_label' in item && item.job_title_label) ||
                ...
                <InputText
                  placeholder=""
                  label={
                    ('employer_label' in item && item.employer_label) ||
                    ('degree_label' in item && item.degree_label) ||
                    ''
                  }
                  reference={
                    ('employer_label' in item && item.employer_label) ||
